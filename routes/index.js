...
router.get('/', function (req, res) {
  res.render('index', { title: 'furnishing App', user: req.user });
});
router.get('/register', function (req, res) {
  res.render('register', { title: 'furnishing App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'furnishing App Login', user: req.user });
});
